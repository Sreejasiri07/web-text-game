	...
	private Room location;
	 ...
	 public Adventurer(String name)
	 {
		 ...
		 public void take(Thing item){
			 ...
			 public String viewAdventurerInventory() {
				    StringBuilder inventoryDetails = new StringBuilder();
				    inventoryDetails.append("Adventurer Inventory:<br/>"); // Using <br/> for HTML line breaks
				    if (inventory.isEmpty()) {
				        inventoryDetails.append("No Item in Inventory<br/>");
				    } else {
				        for (int i = 0; i < inventory.size(); i++) {
				            inventoryDetails.append(i).append("  ").append(inventory.get(i)).append("<br/>");
